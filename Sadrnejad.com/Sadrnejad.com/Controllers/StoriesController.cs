...
namespace Sadrnejad.com.Controllers
{
    public class StoriesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ID,Title,ShortDescription,Article,Meta,UrlSlug,Published,PostedOn,Modified,Category_ID")] Post post)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ID,Title,ShortDescription,Article,Meta,UrlSlug,Published,PostedOn,Modified,Category_ID")] Post post)
        {
            if (ModelState.IsValid)
            {
